            ...
            <aside className="w-80 border-l border-gray-200/80 flex flex-col shrink-0 bg-white overflow-hidden min-h-0 h-full">
              <div className="h-14 border-b border-gray-100 flex items-center justify-between px-4 shrink-0">
                ...
                <div className="flex items-center gap-1">
                  <MemoryPanelComponent isGmail={isAuthenticated && !mockThreads.some(m => m.id === (selectedThread?.id ?? ''))} />
              ...
              <div className="flex-1 min-h-0 overflow-hidden">
                <ErrorBoundary label="AI Chat">
                  <AIChatPanelComponent thread={selectedThread} isGmail={isAuthenticated && !mockThreads.some(m => m.id === (selectedThread?.id ?? ''))} />
                </ErrorBoundary>
              </div>
            </aside>
          )}
